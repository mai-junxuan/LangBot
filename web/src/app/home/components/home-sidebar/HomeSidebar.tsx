    ...
    <Sidebar>
      <SidebarHeader className="p-4">
        <div className="flex items-center gap-3">
          <img className="w-8 h-8" src={langbotIcon.src} alt="langbot-icon" />
          <div className="flex flex-col">
            <div className="text-lg font-semibold">LangBot</div>
        ...
        <SidebarMenu>
          {sidebarConfigList.map((config) => (
            <SidebarMenuItem key={config.id}>
              <SidebarMenuButton
                isActive={
                  selectedChild !== undefined && selectedChild.id === config.id
                }
                onClick={() => {
